...
#ifndef IS659VandleFrame_H
#define IS659VandleFrame_H 1
...
class IS659VandleFrame : public G4VUserDetectorConstruction
{
public:
    IS659VandleFrame(G4VPhysicalVolume* p_mother, G4double p_rho, G4double p_theta, G4double p_phi, G4double p_spin);
    ~IS659VandleFrame();
